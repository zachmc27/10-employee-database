...
class Cli {
    ...
    private viewEmployeesByManager() {

    }

    private viewEmployeesByDepartment() {

    }

    private updateEmployeeManagers() {
    ...
    private mainMenu(): void {
        inquirer
            .prompt([
                {
                    ...
                    choices: ['View All Employees', 'Add Employee', 'Update Employee Role', 'View Employees By Manager',
                        'View Employees By Department', 'Update Employee Managers' , 
            ...
            .then( (answers: any) => {
                ...
                } else if (answers.SelectAction === 'Update Employee Managers') {
